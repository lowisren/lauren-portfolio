    ...
    return(
        <main className="bg-green-100 min-h-screen p-12">
            <section className="container mx-auto">
                <h1 className="text-5xl flex justify-center mono">Blog Post Page</h1>
                <h2 className="text-lg text-gray-600 flex justify-center mb-12 cursive">Welcome, nice to see you.</h2>
